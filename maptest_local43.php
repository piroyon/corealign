...
if(isset($_GET['tabid'])){
	...
	echo "$imagesrc";
	echo '">';
	echo '<div id="showwindow" class="b" onmouseover="showname_drag(\'Sorry, Im not zoomable\')" onmouseout="showname_drag(\'\')" style="position: absolute; left: 0px; top: 0px; height: ';
	echo "$thumwidth";
	echo 'px; width: ';
	echo "$thumwidth";
	echo 'px; \">';
