...
if(isset($_GET['tabid'])){
	...
	echo '.b { font-family: \'Tahoma\'; font-size: 8pt; text-align: center; background-color: #9ACD32; border-color: #006400; border-style: solid; float: left; opacity: 0.5; z-index: 2; }';
	...
	echo '<div id="showwindow" class="b" style="position: relative; left: 0px; top: 0px; height: ';
	echo "$thumwidth";
	echo 'px; width: ';
	echo "$thumwidth";
	echo 'px; \">';
